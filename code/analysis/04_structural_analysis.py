...
DeepPrep output location:
  data/derivatives/deepprep/Recon/sub-XXX_ses-YY/stats/
"""
...
if not GROUP_META.exists():
    raise FileNotFoundError("Run: python3 code/analysis/03_group_participants.py")
...
print()
print(f"✅ Results saved → data/processed/structural/")
print("   Next: python3 code/visualization/05_visualize_results.py")
print()
print("DeepPrep QC reports (single-subject visualization):")
print(f"   data/derivatives/deepprep/QC/sub-*_ses-{SESSION_FOR_ANALYSIS}.html")
