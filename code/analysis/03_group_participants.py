...
Outputs:
  data/processed/groups.csv        — full label file (all 42 subjects)
  data/processed/group_meta.json   — includes pilot_subjects list
  data/processed/pilot_subjects.txt — one subject ID per line (for DeepPrep)
"""
...
if not tsv_path.exists():
    ...
    print("   Run: bash code/preprocessing/01_download_data.sh")
    raise SystemExit(1)
...
print(f"         data/processed/groups.csv")
print(f"         data/processed/group_meta.json")
print(f"         data/processed/pilot_subjects.txt")
print()
...
print()
print("[groups] Next: bash code/preprocessing/02_run_deepprep_anat.sh --pilot")
